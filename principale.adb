      ...
      Get(Choix_G);Skip_Line;
         ...
         WHEN 2 =>
            LOOP
               ...
               Put_Line("5 : Supprimer packs avant une  Date donnée");
               Put_Line("6 : Quitter");
               Get(Reponse); Skip_Line;
               CASE Reponse IS
               ...
               CASE Choixp IS
                  ...
                  WHEN 5 => Cat := Lumiere;
                  WHEN OTHERS => Put_Line("choix non disponible"); exit;
                        END CASE;
                     END LOOP;
            ...
            LOOP
               ...
               CASE Reponse IS
                  ...
                  WHEN 3 =>
                     ...
                     Visu_Locations_Client(Loc,Loca,Identitee);
                  WHEN 4 =>
                     saisie_identite(identitee);
                     Visu_Par_Employe(loc,loca,identiteee);
                  WHEN OTHERS => EXIT;
               END CASE;
            END LOOP;
         WHEN 6 =>
